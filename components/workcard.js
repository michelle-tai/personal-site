...
export default function WorkCard(props){
  ...
  return(
    <div className="col-md-4 col-sm-4 col-6 mb-3 ps-2 pe-2">
          ...
          <div className={"container-fluid justify-content-center " + styles.workCard}>
            <div className="ps-1 pe-1">
              <div className="row pt-3">
                <Image className={utilStyle.roundedCorners} src={props.image} width="500" height="500" responsive="true" quality="50"/>
              </div>
